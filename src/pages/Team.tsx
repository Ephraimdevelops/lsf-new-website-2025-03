...
const Team = () => {
  const { teamMembers, boardMembers, agmMembers, loading, error } = useTeamMembers();
  ...
  return (
    <Layout>
      ...
      <CinematicHero
        ...
        backgroundImage="/lovable-uploads/team-mission-group.png"
        brandPattern="/lovable-uploads/brand-pattern.png"
      />

      {/* AGM Section (Supreme Body) - Restructured */}
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          {/* Top Row: Heading/Description + Compact Mandate Boxes */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-12">

            {/* Left Side: Text Content */}
            <div className="text-left">
              {/* Executive Badge */}
              <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-200 shadow-sm rounded-full px-4 py-1.5 mb-4">
                <Gavel className="h-4 w-4 text-teal-600" />
                <span className="text-teal-700 text-xs font-bold uppercase tracking-widest">Supreme Decision-Making Body</span>
              </div>

              {/* Heading */}
              <h2 className="text-3xl md:text-4xl font-black text-neutral-900 tracking-tight mb-4">
                Annual General <span className="text-teal-600">Meeting</span>
              </h2>

              {/* Content */}
              <p className="text-neutral-600 text-base leading-relaxed border-l-4 border-teal-500 pl-5">
            ...
            {/* Right Side: Compact Horizontal Mandate Boxes */}
            <div className="flex flex-col gap-3">
              {/* Mandate 1 */}
              <div className="bg-teal-50/50 border border-teal-100 rounded-xl p-4 flex items-center gap-4 hover:bg-teal-50 transition-colors">
                <div className="p-2 bg-teal-100 rounded-lg text-teal-600 shrink-0">
                  <Users className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-neutral-900 text-sm">Appoints Board</h4>
                  <p className="text-neutral-500 text-xs">Ensures qualified, community-rooted oversight.</p>
                </div>
              </div>
              ...
              <div className="bg-teal-50/50 border border-teal-100 rounded-xl p-4 flex items-center gap-4 hover:bg-teal-50 transition-colors">
                ...
                <div>
                  <h4 className="font-bold text-neutral-900 text-sm">Approves Strategy</h4>
                  <p className="text-neutral-500 text-xs">Sets the 5-year direction for legal empowerment.</p>
                </div>
              </div>
              ...
              <div className="bg-teal-50/50 border border-teal-100 rounded-xl p-4 flex items-center gap-4 hover:bg-teal-50 transition-colors">
                ...
                <div>
                  <h4 className="font-bold text-neutral-900 text-sm">Financial Integrity</h4>
                  <p className="text-neutral-500 text-xs">Ratifies audited accounts & ensures transparency.</p>
                </div>
              </div>
            </div>
          </div>
                        ...
                        <div className="flex space-x-2">
                          {member.email && (
                            <a
                              ...
                              className="p-2 bg-teal-600/10 text-teal-600 rounded-lg hover:bg-teal-600 hover:text-white transition-colors"
