  ...
  return (
    <Layout>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-transparent to-secondary-teal/20"></div>
        
        {/* Pattern Overlay */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-32 h-32 bg-white rounded-full blur-2xl"></div>
          <div className="absolute bottom-20 right-20 w-40 h-40 bg-secondary-teal rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-secondary-orange rounded-full blur-xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Every news story represents real change, real impact, and real hope in communities across Tanzania
            </p>
          </div>
