...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      {/* Impact Metrics Section - Enhanced with consistent typographic scale */}
      <section className="py-28 md:py-32 bg-gradient-to-br from-primary via-primary-dark to-black text-white relative overflow-hidden">
      ...
      <section className="py-28 md:py-32 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative overflow-hidden">
        <div className="absolute inset-0">
