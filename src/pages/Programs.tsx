      ...
      <section className="bg-primary pattern-bg text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Our Strategic Focus</h1>
            <p className="text-xl opacity-90">
              LSF’s work is anchored in four strategic focus areas that drive our mission to promote justice for all in Tanzania, especially women and vulnerable groups.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-gray max-w-2xl mx-auto">
              We address the most pressing access to justice challenges in Tanzania through these four interconnected focus areas.
            </p>
          </div>
