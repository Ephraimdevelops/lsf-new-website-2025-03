...
const Footer = () => {
  return (
    <footer className="bg-[#3d3c3c] text-white relative overflow-hidden">
      {/* Main Footer Content */}
      <div className="relative container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <h4 className="text-xl font-bold mb-4 text-[#009bb6]">Legal Services Facility</h4>
            ...
            <div className="mb-6">
              <h5 className="text-sm font-semibold mb-3 text-[#009bb6]">Follow Us</h5>
              <div className="flex space-x-2">
                <a href="https://facebook.com/lsf" className="p-2 rounded-full bg-white/10 hover:bg-[#1877F2] transition-all duration-300 group">
                  <Facebook size={16} className="group-hover:scale-110 transition-transform text-[#87154c]" />
                </a>
                <a href="https://instagram.com/lsf" className="p-2 rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-[#E4405F] hover:to-[#F56040] transition-all duration-300 group">
                  <Instagram size={16} className="group-hover:scale-110 transition-transform text-[#87154c]" />
                </a>
                <a href="https://youtube.com/lsf" className="p-2 rounded-full bg-white/10 hover:bg-[#FF0000] transition-all duration-300 group">
                  <Youtube size={16} className="group-hover:scale-110 transition-transform text-[#87154c]" />
                </a>
                <a href="https://tiktok.com/@lsf" className="p-2 rounded-full bg-white/10 hover:bg-black transition-all duration-300 group">
                  <svg className="w-4 h-4 group-hover:scale-110 transition-transform text-[#87154c]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="text-center p-3 bg-white/5 rounded-lg border border-white/10">
                <div className="text-lg font-bold text-[#ffbe06]">26,000+</div>
                <div className="text-xs text-white/70">People Helped</div>
              </div>
              <div className="text-center p-3 bg-white/5 rounded-lg border border-white/10">
                <div className="text-lg font-bold text-[#ffbe06]">184</div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-[#009bb6]">Organization</h4>
          ...
          {/* Programs & Services */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-[#009bb6]">Our Work</h4>
            <ul className="space-y-3">
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-[#009bb6]">Contact</h4>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <MapPin size={16} className="text-[#009bb6] mt-1 flex-shrink-0" />
              ...
              <div className="flex items-center space-x-3">
                <Phone size={16} className="text-[#009bb6] flex-shrink-0" />
                <a href="tel:+255222774790" className="text-white/80 hover:text-white text-sm transition-colors">
                  +255 22 277 4790
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={16} className="text-[#009bb6] flex-shrink-0" />
            ...
            <div className="mt-6 space-y-2">
              <Link to="/contact" className="block">
                <Button variant="outline" size="sm" className="w-full border-white/20 text-white hover:bg-white hover:text-[#3d3c3c] text-xs">
                  Contact Us
                </Button>
              </Link>
              <Link to="/whistleblower" className="block">
                <Button variant="outline" size="sm" className="w-full border-[#ffbe06] text-[#ffbe06] hover:bg-[#ffbe06] hover:text-white text-xs">
                  Report Issue
                </Button>
              </Link>
            </div>
