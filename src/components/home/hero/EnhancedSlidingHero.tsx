          ...
          >
            ...
            <Container size="xl" className="relative z-10 h-full flex items-center">
              <div className="max-w-4xl text-white">
                ...
                <Typography
                  variant="h1"
                  className={`text-white mb-6 text-4xl md:text-5xl lg:text-7xl font-bold leading-tight [text-shadow:_0_2px_4px_rgba(0,0,0,0.5)] transition-all duration-1000 delay-500 ${
                    index === currentSlide ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                  }`}
                >
                  {slide.headline}
                ...
                {slide.subheadline && (
                  <Typography
                    variant="body"
                    className={`text-white/95 mb-8 text-lg md:text-xl max-w-3xl leading-relaxed [text-shadow:_0_1px_3px_rgba(0,0,0,0.4)] transition-all duration-1000 delay-700 ${
                      index === currentSlide ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                    }`}
                  >
                    {slide.subheadline}
